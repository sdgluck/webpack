...
class JavascriptParser extends Parser {
	...
	constructor(sourceType = "auto") {
		...
		this.hooks = Object.freeze({
			/** @type {HookMap<SyncBailHook<[UnaryExpressionNode, NormalModule], BasicEvaluatedExpression | undefined | null>>} */
			evaluateTypeof: new HookMap(
				() => new SyncBailHook(["expression", "module"])
			),
			/** @type {HookMap<SyncBailHook<[ExpressionNode], BasicEvaluatedExpression | undefined | null>>} */
			evaluate: new HookMap(() => new SyncBailHook(["expression"])),
			/** @type {HookMap<SyncBailHook<[IdentifierNode | ThisExpressionNode | MemberExpressionNode | MetaPropertyNode, NormalModule], BasicEvaluatedExpression | undefined | null>>} */
			...
			/** @type {HookMap<SyncBailHook<[ExpressionNode, NormalModule], boolean | void>>} */
			typeof: new HookMap(() => new SyncBailHook(["expression", "module"])),
			...
			/** @type {HookMap<SyncBailHook<[ExpressionNode, NormalModule], boolean | void>>} */
			expression: new HookMap(() => new SyncBailHook(["expression", "module"])),
	...
	walkMetaProperty(metaProperty) {
		this.hooks.expression
			.for(getRootName(metaProperty))
			.call(metaProperty, this.state.module);
	}
